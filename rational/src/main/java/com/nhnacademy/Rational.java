...
//         // if(!(object instanceof Rational)) return false; //null도 체킹됨
//         // Rational rational = (Rational) object;
//         // if(getNumerator()* rational.getDenominator() == getDenominator() * rational.getNumerator()){
//         //     return true;
//         // }
//         // else{
//         //     return false;
...
//                 && (getNumerator() == (((Rational) object).getNumerator())) 
//                 && (getDenominator()== ((Rational) object).getDenominator());
//                 // && (getNumerator() * (((Rational) object).getDenominator()) == getDenominator() * ((Rational) object).getNumerator());
...
//     }
//     public Rational pow(){
//         return new Rational((int) Math.pow(getNumerator(),2), (int) Math.pow(getDenominator(),2));
//     }
//     public static int gcd(int num1, int num2) { //최대공약수 구하기 함수
//         if((num1 < 0)||(num2 < 0)){
//             throw new ArithmeticException();
//         }
//         if (num2 == 0){
